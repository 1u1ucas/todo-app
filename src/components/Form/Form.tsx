...
const Form = ({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen} defaultOpen={false}>
      <DialogContent>
        <DialogTitle>{todo ? "Modifier une tâche" : "Ajouter une tâche"}</DialogTitle>
        <DialogDescription>
          {todo ? "Modifiez les détails de la tâche ci-dessous." : "Remplissez les détails de la nouvelle tâche ci-dessous."}
        </DialogDescription>
        <form
